...
/**
 * The drop page. Reading searchParams makes this dynamic, which is what we
 * want — the days-remaining figure and the open/closed state should never be
 * served from a stale cache while a deadline is running.
 */
...
export default async function RunbackPage({
  searchParams,
}: {
